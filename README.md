...
- Java 23, Oracle Open JDK 23.0.2
- Maven
...
# ЗАПУСТИТЬ BACKEND
Открыть каталог `\Supply-Application\backend` в IntelliJ IDEA.
...
# ЗАПУСТИТЬ FRONTEND:
Открыть каталог `\Supply-Application\frontend` в Visual Studio Code.
